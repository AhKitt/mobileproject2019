...
File _image;
String pathAsset = 'assets/images/job.png';
...
class NewJob extends StatefulWidget {
  ...
  const NewJob({Key key, this.plumber}) : super(key: key);
      ...
      child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: CreateNewJob(widget.plumber),
            ),
          )),
    );
  }
...
class _CreateNewJobState extends State<CreateNewJob> {
  ...
  void _loadmap() async  {
    LocationResult result = await Navigator.of(context).push(
        MaterialPageRoute(builder: (context) => PlacePicker("AIzaSyCJoGP_fDS4k-KR4cInv80OWcjE-kETTXI")));
